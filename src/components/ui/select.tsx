  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-popover/85 supports-[backdrop-filter]:bg-popover/70 text-popover-foreground backdrop-blur-xl relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-2xl border border-border",
          position === "popper" &&
